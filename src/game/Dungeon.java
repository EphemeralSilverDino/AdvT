...
public class Dungeon{
  ...
  Door[] doors = new Door[] {new Door("src/images/DungeonDoor.png",400,0,"up"),new Door("src/images/DoorLeft.png",810,350,"left"),new Door("src/images/DungeonDoor.png",400,600,"down"),new Door("src/images/DoorLeft.png",0,400,"right")};
  public Dungeon(){
    this(new Room("src/images/RoomSpriteSheet.png",0,0,1,18),7);
  }
  ...
  public void generateRoom(Room room,int count){
    ...
    if (count<rTotal){
      ...
      if (outOfBounds(temp) || map[x][y]!=null || (!hasSpace(temp) && loops<125)){
        ...
        if (map[x][y]==null){
          Room newRoom = new Room(room,"src/images/DungeonBackground.png",0,0);
