...
public class StatBars{
  ...
  public StatBars(int x, int y){
    this.x=x;
    this.y=y;
    hpBar = new RenderedEntity("src/images/HealthBar.png",x,y);
    manaBar = new RenderedEntity("src/images//ManaBar.png",x,y+60);
    manaGauge = new RenderedEntity("src/images/ManaGuage.png",x,y+60);
    hpGauge = new RenderedEntity("src/images/HealthGuage.png",x,y);
